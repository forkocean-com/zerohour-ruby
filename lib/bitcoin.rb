...
module Bitcoin
  ...
  NETWORKS = {
    bitcoin: {
      ...
      message_magic: "ZHCash Signed Message:\n",
      address_version: "50",
      p2sh_version: "128",
      privkey_version: "80",
      ...
      coinbase_maturity: 100,
      reward_base: 800 * COIN,
      reward_halving: 10_000_000_000,
      retarget_interval: 2016,
      ...
      genesis_hash: "00007af309bdd818599502f8fc8af0943c4ce302df2298b14e59abd0c38e07b0",
      proof_of_work_limit: 0x1f00ffff,
      known_nodes: [
        'hub1.zh.cash',
        'hub2.zh.cash',
        'hub3.zh.cash',
      ...
      checkpoints: {
         0 => "00007af309bdd818599502f8fc8af0943c4ce302df2298b14e59abd0c38e07b0",
         100000 => "354bbe24bdfb8b8c7fc2ad1eb92effec87b964aa22c89678d7c606881c705263",
         300000 => "d20bcc9919dda2c8babcb1a62d6c1692c6be8f59ca47bfd0b0c47ed8d10e830e",
        600000 => "c4d8400a5e2d7af03f081daa5236c68848ce58311a5ef0f82cf62e5b2d29d92f",
        700000 => "e3a193c62ac43ce013e7ff9cb9bb7a600d312ad296b5c11c9b44623aca82c250"
      }
    }
  }
