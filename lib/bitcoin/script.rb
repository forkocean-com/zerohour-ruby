...
class Bitcoin::Script
  ...
  def self.to_call_script(data)
    ...
    out_script.append_pushdata(raw_script[0].to_i.to_s(16))
    out_script.append_pushdata(raw_script[1].to_i.to_s(16))
    out_script.append_pushdata(raw_script[2].to_i.to_s(16))
    out_script.append_pushdata(raw_script[3])
    out_script.append_pushdata(raw_script[4])
    out_script.append_opcode(194)
    [out_script.to_payload].pack("H*").reverse.unpack("H*")
  end
