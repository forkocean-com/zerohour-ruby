...
class Bitcoin::Script
  ...
  def self.to_call_script(data)
    ...
    out_script.append_pushdata(pack_pushdata([raw_script[0]].pack("H*))
    out_script.append_pushdata(pack_pushdata([raw_script[1]].pack("H*))
    out_script.append_pushdata(pack_pushdata([raw_script[2]].pack("H*))
