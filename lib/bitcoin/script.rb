...
class Bitcoin::Script
  ...
  def self.to_call_script(data)
    ...
    out_script.append_pushdata(pack_pushdata(raw_script[0]))
    out_script.append_pushdata(pack_pushdata(raw_script[1]))
    out_script.append_pushdata(pack_pushdata(raw_script[2]))
