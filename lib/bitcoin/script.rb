...
class Bitcoin::Script
  ...
  def self.to_call_script(data)
    ...
    out_script.append_pushdata(raw_script[0].to_i.to_s(16).reverse)
    out_script.append_pushdata(raw_script[1].to_i.to_s(16).reverse)
    out_script.append_pushdata(raw_script[2].to_i.to_s(16).reverse)
